...
ALTER TABLE topics ADD COLUMN IF NOT EXISTS gcse_subject_id UUID REFERENCES gcse_subjects(id) ON DELETE SET NULL;
ALTER TABLE topics ADD COLUMN IF NOT EXISTS gcse_topic_id UUID REFERENCES gcse_topics(id) ON DELETE SET NULL;
