-- Fix user_profiles table by adding missing profile columns
-- This migration adds the missing profile columns that were defined in create_authentication_tables.sql
-- but got overridden by create_gamification_tables.sql
